...
function showGithubRepos() {
  ...
  getGitHubData().then(data => {
    ...
    <p style="margin-top: auto;"><a>Stars:</a> <a>${repository.stargazers_count}</a></p>
    <p><a>Language:</a> <a tippy="${repository.language}">${properties.languages[`${repository.language}`] || repository.language}</a></p>`;
